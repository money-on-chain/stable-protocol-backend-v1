...
import { redeemRiskpro } from '../../src/moc-v0/moc-coinbase.js'
import { redeemRiskproRRC20 } from '../../src/moc-v0/moc-rrc20.js'
...
const main = async () => {
  ...
  if (configProject.appMode === 'MoC') {
    // Collateral Coinbase
    const { receipt, filteredEvents } = await redeemRiskpro(web3, dContracts, configProject, amountRiskpro)
  } else {
    // Collateral RRC20
    const { receipt, filteredEvents } = await redeemRiskproRRC20(web3, dContracts, configProject, amountRiskpro)
  }
}
