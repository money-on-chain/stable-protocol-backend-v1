...
const calcCommission  = async (web3, dContracts, dataContractStatus, reserveAmount, token, action) => {
    ...
    switch (token) {
        ...
        case 'STABLE':
            if (action === 'MINT') {
                reserve_type = dataContractStatus["commissionRatesTypes"]["MINT_STABLETOKEN_FEES_RESERVE"];
                moc_type = dataContractStatus["commissionRatesTypes"]["MINT_STABLETOKEN_FEES_MOC"];
            } else {
                reserve_type = dataContractStatus["commissionRatesTypes"]["REDEEM_STABLETOKEN_FEES_RESERVE"];
                moc_type = dataContractStatus["commissionRatesTypes"]["REDEEM_STABLETOKEN_FEES_MOC"];
            }            
            break;
        case 'RISKPRO':
            if (action === 'MINT') {
                reserve_type = dataContractStatus["commissionRatesTypes"]["MINT_RISKPRO_FEES_RESERVE"];
                moc_type = dataContractStatus["commissionRatesTypes"]["MINT_RISKPRO_FEES_MOC"];
            } else {
                reserve_type = dataContractStatus["commissionRatesTypes"]["REDEEM_RISKPRO_FEES_RESERVE"];
                moc_type = dataContractStatus["commissionRatesTypes"]["REDEEM_RISKPRO_FEES_MOC"];
            }
            break;
        case 'RISKPROX':
            if (action === 'MINT') {
                reserve_type = dataContractStatus["commissionRatesTypes"]["MINT_RISKPROX_FEES_RESERVE"];
                moc_type = dataContractStatus["commissionRatesTypes"]["MINT_RISKPROX_FEES_MOC"];
            } else {
                reserve_type = dataContractStatus["commissionRatesTypes"]["REDEEM_RISKPROX_FEES_RESERVE"];
                moc_type = dataContractStatus["commissionRatesTypes"]["REDEEM_RISKPROX_FEES_MOC"];
            }
            break;    
    }
