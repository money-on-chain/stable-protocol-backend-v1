...
const connectorAddresses  = async (web3, multicall, moc) => { 
    ...
    const MoCConnector = readJsonFile('./abis/MoC/MoCConnector.json');   
...
const main  = async () => {
    ...
    const MoC = readJsonFile('./abis/MoC/MoC.json');
    const MoCState = readJsonFile('./abis/MoC/MoCState.json');
    const MoCExchange = readJsonFile('./abis/MoC/MoCExchange.json');
    const MoCInrate = readJsonFile('./abis/MoC/MoCInrate.json');
    const MoCSettlement = readJsonFile('./abis/MoC/MoCSettlement.json');
    const DocToken = readJsonFile('./abis/MoC/DocToken.json');
    const BProToken = readJsonFile('./abis/MoC/BProToken.json');
    const MoCToken = readJsonFile('./abis/MoC/MoCToken.json');
