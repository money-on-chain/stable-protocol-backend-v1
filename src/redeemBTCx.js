...
const { readContracts, redeemBTCx } = require('./core');
...
const main  = async () => {
    ...
    const amountBTCx = `${process.env.OPERATION_AMOUNT_REDEEM_BTCX}`;
       
    // Send transaction and get receipt
    const receipt = await redeemBTCx(web3, dContracts, amountBTCx);
